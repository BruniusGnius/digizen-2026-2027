...
**Input:** el copy completo de `00-context/` + `01-design-system.md` aprobado. El copy es inmutable: no se resume, parafrasea, omite ni completa con texto inventado.
...
Incluye una auditoría fuente → bloque antes del gate: confirma que todo copy de producción está presente literalmente, conserva las notas internas completas fuera de la UI pública y enumera, sin suplirlos, los contenidos aún no proporcionados.
